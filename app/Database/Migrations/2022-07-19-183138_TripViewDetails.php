...
class TripViewDetails extends Migration
{
    public function up()
    {
           $prefix= $this->db->DBPrefix;
        $sql = "CREATE view ".$prefix."tripDetailView AS SELECT 
	...
	".$prefix."profile_driver prof on prof.id_driver =adv.id_driver JOIN
	".$prefix."users users on users.id_user =prof.id_user  JOIN
