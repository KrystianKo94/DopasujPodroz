                        ...
                        <div class="col-lg-12">
                            <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                <div class="au-card-title" >
                                    ...
                                    <h3>
                                        <i class="fas fa-plus-square"></i>Dane osobowe</h3>
                                </div>
                                    ...
                                    <div class="au-chat">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <hr>
                                                <form id="userData" method="post" novalidate="novalidate">
                                                    <div class="form-group">
                                                        <label for="license" class="control-label mb-1">Imię</label>
                                                        <input id="name" name="name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="license" class="control-label mb-1">Nazwisko</label>
        ...
        $('#userData').validate(
            {
                ...
                messages: {
                    name: {
                        required: "Prosze wprowadzic imie"
                        
                    },
                    surname: {
                        required: "Prosze wprowadzic nazwisko"
