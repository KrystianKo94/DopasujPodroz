                        ...
                        <div class="col-md-8 col-lg-12">
                            <div class="user-data m-b-30">
                                <h3 class="title-3 m-b-30">
                                    <i class="zmdi zmdi-home"></i>Lista rezerwacji</h3>
                                                            ...
                                                            <div class="account-dropdown__body">
                                                                <div class="account-dropdown__item">
                                                                    <a href="javascript:descriptionShow(1)">
                                                                        <i class="zmdi zmdi-edit"></i>Zobacz szczegóły ogłoszenia</a>
                                                                </div>
                                                                <div class="account-dropdown__item">
                                                                    <a href="javascript:writeToDriver(1)">
                                                                        <i class="zmdi zmdi-code"></i>Napisz wiadomość do kierowcy</a>
                                                                </div>
                                                                <div class="account-dropdown__item">
                                                                    <a href="javascript:cancelReservation(1)">
                                                                        <i class="zmdi zmdi-delete"></i>Anuluj rezerwacje</a>
                                                                </div>
                                                                <div class="account-dropdown__item">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <div class="au-card-title" >
                            <div class="bg-overlay bg-overlay--blue "></div>
                            <h3>
                                <i class="zmdi zmdi-edit"></i>Anuluj rezerwacje</h3>
                        </div>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td>
                            <div class="form-group" >
                                <label for="exampleFormControlTextarea1">Opisz powód dla którego chcesz anulować reserwacje:</label>
                                <textarea class="form-control" id="message_text" rows="3"></textarea>
                            </div>
                            <button type="button" class="btn btn-danger">Wyślij wiadomość</button>
                        </td>
